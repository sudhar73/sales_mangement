...
class Texts {
  ...
  static TextStyle primary1bigbold() {
    return TextStyle(
        color: HexColor("#023781"), fontSize: 18, fontWeight: FontWeight.bold);
  }

  static TextStyle primary1bbold() {
    return TextStyle(
        color: HexColor("#4D4F5C"), fontSize: 18, fontWeight: FontWeight.bold);
  }

  static TextStyle primary1c() {
    return TextStyle(
        color: HexColor("#4D4F5C"), fontSize: 22, fontWeight: FontWeight.bold);
  }

  static TextStyle primary1d() {
    return TextStyle(
        color: HexColor("#172B4D"), fontSize: 18, fontWeight: FontWeight.bold);
  }
  ...
  static TextStyle primary3a() {
    return TextStyle(
        color: HexColor("#7C8EB2"), fontSize: 18, fontWeight: FontWeight.w600);
  }
