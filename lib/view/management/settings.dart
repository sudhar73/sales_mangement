            ...
            Container(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: 8, right: 8, top: 10),
                  child:
                      Text("Provident Fund Settings", style: Texts.primary2a()),
                ),
                Padding(
                    padding: const EdgeInsets.only(left: 1, right: 8, top: 10),
                    child: Switchscreen())
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8, right: 8, top: 10),
              child:
                  Text("Offer/Promotional Approval", style: Texts.primary1d()),
            ),
            Container(
                child: Row(
              children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8, right: 8, top: 10),
              child:
                  Text("Resignation Notice Approval", style: Texts.primary1d()),
            ),
            Container(
                child: Row(
              children: [
