...
Center(
  child:  Row(
    ...
    children: [
   Container(child:Text("All Follow-Up Call",style:Texts.primary1d())),
   Container(
 
     width:Get.width/2.66,color:Colors.transparent,
     child: Padding(
 ...
 margin:EdgeInsets.only(left:5,top:5),
  ...
  _addexit(BuildContext context) {
    ...
    return new AlertDialog(
      ...
      title:  Center(child: Text('Add Follow-Up Call',style:Texts.primary1bigbold())),
