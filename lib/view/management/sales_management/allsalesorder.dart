...
Center(
  child:  Container(child:Text("All Sales Orders",style:Texts.primary1d())),
),
SizedBox(height:5),
 Container(
 ...
 margin:EdgeInsets.only(left:5,top:5),
  ...
  _addexit(BuildContext context) {
    ...
    return new AlertDialog(
      ...
      title:  Center(child: Text('All Sales Orders',style:Texts.primary1bigbold())),
   ...
   return  Form(
     ...
     child: Column(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                            ...
                            validator: (String? value) {
                                    if (value!.isEmpty) {
                                      return "Quote Value is required";
                                    }
                                    return null;
                                  },
                                  onSaved: (String? address) {
