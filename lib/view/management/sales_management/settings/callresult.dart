...
class Callresult extends StatefulWidget {
  const Callresult({ Key? key }) : super(key: key);

  @override
  _CallresultState createState() => _CallresultState();
}
                    ...
                    GridColumn(
                        ...
                        label: Container(
                          color: HexColor("#023781"),
                            padding: EdgeInsets.all(8.0),
                            alignment: Alignment.center,
                            child: Text('Call Result',style:Texts.whit1e(),textAlign: TextAlign.center,))),
                    GridColumn(
                        columnName: 'action',
                        label: Container(
                          color: HexColor("#023781"),
