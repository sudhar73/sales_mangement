...
class Department_settings extends StatefulWidget {
  const Department_settings({ Key? key }) : super(key: key);

  @override
  _Department_settingsState createState() => _Department_settingsState();
}

class _Department_settingsState extends State<Department_settings> {
                    ...
                    GridColumn(
                        ...
                        label: Container(
                          color: HexColor("#023781"),
                            padding: EdgeInsets.all(8.0),
                            alignment: Alignment.center,
                            child: Text('Department',style:Texts.whit1e(),textAlign: TextAlign.center,))),
                    GridColumn(
                        columnName: 'action',
                        label: Container(
                          color: HexColor("#023781"),
