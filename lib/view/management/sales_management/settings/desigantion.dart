...
class Desigination_settings extends StatefulWidget {
  const Desigination_settings({ Key? key }) : super(key: key);

  @override
  _Desigination_settingsState createState() => _Desigination_settingsState();
}

class _Desigination_settingsState extends State<Desigination_settings> {
                    ...
                    GridColumn(
                        ...
                        label: Container(
                          color: HexColor("#023781"),
                            padding: EdgeInsets.all(8.0),
                            alignment: Alignment.center,
                            child: Text('Designation',style:Texts.whit1e(),textAlign: TextAlign.center,))),
                    GridColumn(
                        columnName: 'action',
                        label: Container(
                          color: HexColor("#023781"),
