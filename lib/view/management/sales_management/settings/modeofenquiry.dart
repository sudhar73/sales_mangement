...
class Modeofenquriy extends StatefulWidget {
  const Modeofenquriy({ Key? key }) : super(key: key);

  @override
  _ModeofenquriyState createState() => _ModeofenquriyState();
}

class _ModeofenquriyState extends State<Modeofenquriy> {
                    ...
                    GridColumn(
                        ...
                        label: Container(
                          color: HexColor("#023781"),
                            padding: EdgeInsets.all(8.0),
                            alignment: Alignment.center,
                            child: Text('Mode of enquiry',style:Texts.whit1e(),textAlign: TextAlign.center,))),
                    GridColumn(
                        columnName: 'action',
                        label: Container(
                          color: HexColor("#023781"),
