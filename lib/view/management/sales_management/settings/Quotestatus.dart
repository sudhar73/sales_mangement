...
class Quotese extends StatefulWidget {
  const Quotese({ Key? key }) : super(key: key);

  @override
  _QuoteseState createState() => _QuoteseState();
}

class _QuoteseState extends State<Quotese> {
                    ...
                    GridColumn(
                        ...
                        label: Container(
                          color: HexColor("#023781"),
                            padding: EdgeInsets.all(8.0),
                            alignment: Alignment.center,
                            child: Text('Quote Status',style:Texts.whit1e(),textAlign: TextAlign.center,))),
                    GridColumn(
                        columnName: 'action',
                        label: Container(
                          color: HexColor("#023781"),
