          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 15),
                Container(
                    child: Text("Please Enter 4 Digit Code Sent to",
                        style: Texts.style(
                            16.0, HexColor("#023781"), FontWeight.normal))),
                Container(
                    child: Text("mani1995@gmail.com",
                        style: Texts.style(
                            18.0, HexColor("#023781"), FontWeight.normal))),
                SizedBox(height: 10),
                Padding(
                ...
                Container(
                    child: Text("Resend Code",
                        style: Texts.style(
                            18.0, HexColor("#7C8EB2"), FontWeight.bold))),
                SizedBox(height: 10),
                Padding(
