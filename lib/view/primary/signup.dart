...
class _SignupState extends State<Signup> {
  SignupModel signupmodel =SignupModel(companyname: '', companywebsite: '', email: '', password: '', name: '', phonenumber: '');
               ...
               child: Card(
                 ...
                 child: Container(
                   child:TextFormField(
                     ...
                     "User Name", "Enter Your Name", Icon(Icons.person_outline,color: Colors.grey,),
                 ),
                 validator: (value){
                   if(value!.isEmpty){ 
                 ...
                 child: Container(
                   child:TextFormField(
                    keyboardType: TextInputType.emailAddress,
                     decoration: Texts.Textfeild2(
                     "Email", "Enter Your Email", Icon(Icons.email,color: Colors.grey,),
                 ),
                 validator: (value){
                   if(value!.isEmpty){ 
               ...
               child: Card(
                 ...
                 child: Container(
                   child:TextFormField(
                     ...
                     "company name", "Enter Your Company name", Icon(Icons.business,color: Colors.grey,),
               ...
               child: Card(
                 ...
                 child: Container(
                   child:TextFormField(
                     ...
                     "company Website", "Enter Your company Website", Icon(Icons.devices_other,color: Colors.grey,),
  ...
  void _loginButtonAction(String? name,email,password,phonenumber,companyname,companywebsite) async {
