              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Image(
                      image:
                          AssetImage("assets/dashboard/dashboard-active.png"),
                    ),
                          ...
                          child: Row(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(4.0),
                                child:
                                    Text("This week", style: Texts.primary1b()),
                              ),
                              Spacer(),
                              Padding(
                                padding: const EdgeInsets.all(4.0),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Icon(Icons.circle_outlined,
                          color: HexColor("#FEB468")),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        "Ticket Left",
                        style: Texts.primary2a(),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: Text("The Story’s of Danau Toba ",
                            style: Texts.primary1b()),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(4.0),
                        child:
                            Text("(Drama Theater)", style: Texts.primary1b()),
                      ),
                      ListTile(
